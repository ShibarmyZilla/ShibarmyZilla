...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardToken = address(0x940230b6b7ef1979a28F32196A8e3439C645BA49); // SHIBARMY
  }
...
contract ShibarmyZilla is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ShibarmyZilla", "SZILLA", 9) {
        
        address newOwner = address(0x3Db3aE5AFdBA1AC93F5B7307D916A8C537E3C25F);
    
        uint256 _rewardsFee = 5;
        uint256 _marketingFee = 2;
        uint256 _liquidityFee = 2;
        
        uint256 totalSupply = 69 * 1e15 * 1e9;
    	...
    	marketingWallet = address(0xa1df200bDBd6Df832682e6735a56fe49382E4Daf); // set as marketing wallet
